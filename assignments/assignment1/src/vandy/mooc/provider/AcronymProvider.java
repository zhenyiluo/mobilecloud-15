...
public class AcronymProvider extends ContentProvider {
	...
	private static UriMatcher buildUriMatcher() {
		...
		matcher.addURI(AcronymContract.CONTENT_AUTHORITY,
				AcronymContract.PATH_ACRONYM, ACRONYMS);
		matcher.addURI(AcronymContract.CONTENT_AUTHORITY,
				AcronymContract.PATH_ACRONYM + "/#", ACRONYM);
		return matcher;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case ACRONYM:
			...
			// from Uri.
			final String rowId = "" + AcronymContract.AcronymEntry._ID + " = '"
	 ...
	 * As a courtesy, notifyChange() is called after deleting.
	 */
	@Override
	...
	private static String addRowIdCheckToWhereStatement(String whereStatement,
			String id) {
